...
createResponder({
    ...
    async run(interaction) {
        ...
        await interaction.editReply({
            components: [
                createContainer(constants.colors.white, `\u{2705} Status do player atualizado para **${selectedStatus.label}**.`),
            ],
        });
    },
});
